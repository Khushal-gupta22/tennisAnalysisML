...
import constants
from utils import (
    conver_pixel_to_distance_to_meters,
    convert_mts_to_pixel_distance,
    get_foot_position,
...
class MiniCourt() : 
    def __init__(self, frame):
        ...
        self.set_cavvas_bg_box_position(frame)
        self.set_mini_court_position()
        self.set_court_drawing_keypoints()
        self.set_court_lines()

    def convert_meters_to_pixels(self, meters):
        return convert_mts_to_pixel_distance( 
                                            meters,
                                            constants.DOUBLE_LINE_WIDTH,
                                            self.court_drwing_width
                                        )
    ...
    def set_court_drawing_keypoints(self):
        ...
        #point 3
        drawing_key_points[6] = drawing_key_points[0] + self.court_drwing_width
    ...
    def set_mini_court_position(self):
        ...
        self.court_drwing_width = self.court_end_x - self.court_start_x  

    def set_cavvas_bg_box_position(self, frame):
        frame = frame.copy()
    ...
    def get_width_of_mini_court(self):
        return self.court_drwing_width
    ...
    def get_mini_court_coordinates(self, 
        ...
        distance_from_keypoint_x_meters = conver_pixel_to_distance_to_meters(
                                                                    distance_from_keypoint_x_pixels,
                                                                    player_height_in_meters,
                                                                    player_height_in_pixels
                                                                )
        distance_from_keypoint_y_meters = conver_pixel_to_distance_to_meters(
                                                                    distance_from_keypoint_y_pixels,
                                                                    player_height_in_meters,
                                                                    player_height_in_pixels
                                                                )
        
        # convert to mini court coo-ordinates 
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_keypoints):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                closest_keyponint = (original_court_keypoints[closest_keypoint_index*2], original_court_keypoints[closest_keypoint_index*2 + 1])
                
                
                # Get the player height in pixels 
                frame_index_min = max(0, frame_num - 20)
                frame_index_max = min(len(player_boxes), frame_num + 50)
                bboxes_height_in_pixels = [get_height_of_bbox(player_boxes[frame_index][player_id]) for frame_index in range(frame_index_min, frame_index_max)]
